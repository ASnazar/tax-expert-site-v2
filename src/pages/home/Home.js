        ...
        <div className={style.box} >
            ...
            <div className={style.boxWelcomeWithImg}>
                <div className={style.boxWelcome}>
                    ...
                    <motion.p custom={3} variants= {textAnimation} className={style.p11}>{t('home.firstHelloBlock.titleText')}</motion.p>
                    <motion.a custom={4} variants= {textAnimation}  onClick={() => setModalActive(true)} className={style.btn}>{t('home.firstHelloBlock.button')}</motion.a>
                </div>
            </div>
            </motion.section>
